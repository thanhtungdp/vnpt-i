      ...
      advanced.push(
        <Row gutter={24}>
          <Col span={6} key={d.key}>
            <FormItem label={t('searchFrom.form.measuringList.label')}>
          ...
          <Col span={6} key={d.key + 'Operator'}>
            <FormItem label={t('searchFrom.form.operator.label')}>
          ...
          <Col span={6} key={d.key + 'Value'}>
            <FormItem label={t('searchFrom.form.value.label')}>
        ...
        <Form onSubmit={this.changeSearch}>
          <Row gutter={24}>
            ...
            <Col span={6} key="stationAuto">
              <FormItem label={t('searchFrom.form.stationAuto.label')}>
            ...
            <Col span={6} key="fromDate">
              <FormItem label={t('searchFrom.form.fromDate.label')}>
            ...
            <Col span={6} key="toDate">
              <FormItem label={t('searchFrom.form.toDate.label')}>
          ...
          <Row gutter={24}>
            ...
            <Col span={6} key="isExceeded">
              <FormItem label={t('searchFrom.form.isExceeded.label')}>
