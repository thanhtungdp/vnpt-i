...
export default class SubscriptionOverview extends React.PureComponent {
  rightRenew() {
    return <Button type="primary">{translate('supscriptionStatus.Renew')}</Button>
  }
    ...
    return (
      ...
      >
        <SubscriptionOverviewWrapper>
          ...
          <Row>
            <Col md={4}>
              <HeadingIntro>{translate('supscriptionStatus.currentSubscription')}</HeadingIntro>
            ...
            <Col md={8}>
              <HeadingIntro>{translate('supscriptionStatus.subscriptionHistory')}</HeadingIntro>
